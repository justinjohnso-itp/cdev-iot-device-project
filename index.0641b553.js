...
var _chartjsScaleTimestack = require("chartjs-scale-timestack");
(0, _auto.Chart).register((0, _chartjsPluginZoomDefault.default));
// Fetch data
...
async function drawChart() {
    ...
    sensorChart = new (0, _auto.Chart)(document.getElementById("tof-sensor"), {
        type: "line",
        data: {
            labels: labels,
            datasets: [
...
},{"chart.js/auto":"d8NN9","chartjs-plugin-zoom":"kMtu7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","chartjs-scale-timestack":"4zQKz"}],"d8NN9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"kMtu7":[function(require,module,exports,__globalThis) {
/*!
...
},{"./chunks/helpers.segment.js":"7oQuk","@kurkle/color":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4zQKz":[function(require,module,exports,__globalThis) {
// src/index.ts
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DEF_TICK_GENERATORS", ()=>DEF_TICK_GENERATORS);
parcelHelpers.export(exports, "DEF_TOOLTIP_FORMAT", ()=>DEF_TOOLTIP_FORMAT);
parcelHelpers.export(exports, "DaysTickGenerator", ()=>DaysTickGenerator);
parcelHelpers.export(exports, "HM", ()=>HM);
parcelHelpers.export(exports, "HMS", ()=>HMS);
parcelHelpers.export(exports, "MD", ()=>MD);
parcelHelpers.export(exports, "MDAY", ()=>MDAY);
parcelHelpers.export(exports, "MON", ()=>MON);
parcelHelpers.export(exports, "TickGenerator", ()=>TickGenerator);
parcelHelpers.export(exports, "TimestackScale", ()=>TimestackScale);
parcelHelpers.export(exports, "YEAR", ()=>YEAR);
parcelHelpers.export(exports, "YM", ()=>YM);
parcelHelpers.export(exports, "YMD", ()=>YMD);
parcelHelpers.export(exports, "YearsTickGenerator", ()=>YearsTickGenerator);
...
function find_widest_local_date(key, format, ctx, opts) {
    ...
    const num = (0, _luxon.DateTime).fromObject(widest_numeric_date, opts);
    function* months_candidates(base) {
        for(let i = 1; i <= 12; i++)yield base.set({
            month: i
        });
    }
    const sm = _pick_widest_sample(ctx, months_candidates(num), {
        month: "short"
    });
    const lm = _pick_widest_sample(ctx, months_candidates(num), {
        month: "long"
    });
    function* weekdays_candidates(base) {
        for(let i = 22; i < 29; i++)yield base.set({
            day: i
        });
    }
    const sm_sw = _pick_widest_sample(ctx, weekdays_candidates(sm), {
        weekday: "short"
    });
    const sm_lw = _pick_widest_sample(ctx, weekdays_candidates(sm), {
        weekday: "long"
    });
    const sm_nw = _pick_widest_sample(ctx, weekdays_candidates(sm), {
        weekday: "narrow"
    });
    const lm_sw = _pick_widest_sample(ctx, weekdays_candidates(lm), {
        weekday: "short"
    });
    const lm_lw = _pick_widest_sample(ctx, weekdays_candidates(lm), {
        weekday: "long"
    });
    const lm_nw = _pick_widest_sample(ctx, weekdays_candidates(lm), {
        weekday: "narrow"
    });
    const perms = {
    ...
    const result = Object.fromEntries(Object.entries(perms).map(([k, v])=>[
            k,
            v.toObject()
        ]));
...
function measure_max_label_width(format, ctx, opts) {
    ...
    const dt_key = `${opts.locale || (0, _luxon.Settings).defaultLocale}/${ctx.font}`;
    ...
    const dt = (0, _luxon.DateTime).fromObject(widest_date, opts);
...
var TickGenerator = class {
   ...
   */ *seq(from) {}
    ...
    estimate(range, ctx, opts, may_be_long = true) {
        ...
        const top_est = {
            nticks: range / top.size,
            label_width: Math.max(normal, major)
        };
        let bottom_est;
        if (bottom) {
            ...
            bottom_est = {
                nticks: range / bottom.size,
                label_width: Math.max(short, long)
            };
        }
        return {
            top: top_est,
    ...
    format(dt, is_major, with_bottom, prefer_long_bottom) {
        ...
        const bottom = dt.toLocaleString(prefer_long_bottom && this.bottom.long_fmt ? this.bottom.long_fmt : this.bottom.short_fmt);
        return [
            top,
            bottom
        ];
...
var MonoTickGenerator = class extends TickGenerator {
    constructor(top, bottom){
        ...
        super({
            fmt,
            maj_fmt,
            size: (0, _luxon.Duration).fromDurationLike(top_duration).toMillis()
        }, bottom && {
            ...bottom,
            size: (0, _luxon.Duration).fromObject({
                [bottom.unit]: 1
            }).toMillis()
        });
...
var DaysTickGenerator = class extends TickGenerator {
    constructor(top, bottom){
        super({
            ...top,
            size: top.step * 86400000
        }, bottom && {
            ...bottom,
            size: 2592000000
        });
        this.days = top.days;
        this.maj_days = top.maj_days ?? [
            1
        ];
        this.bottom_days = bottom ? bottom.days ?? [
            1
        ] : [];
    }
    *seq(from) {
...
var DEF_TICK_GENERATORS = [
    ...
    new YearsTickGenerator(1, {
        fmt: YEAR
    }),
    new YearsTickGenerator(5, {
        fmt: YEAR
    }),
    new YearsTickGenerator(10, {
        fmt: YEAR
    }),
    new YearsTickGenerator(25, {
        fmt: YEAR
    }),
    new YearsTickGenerator(50, {
        fmt: YEAR
    }),
    new YearsTickGenerator(100, {
        fmt: YEAR
    }),
    // fallback )
    new YearsTickGenerator(1e3, {
        fmt: YEAR
    })
];
// src/scale.ts
...
var TimestackScale = class extends (0, _chartJs.Scale) {
    constructor(cfg){
        var _a, _b, _c, _d, _e;
        super(cfg);
        ...
        this._gens = gens;
        if (opts == null ? void 0 : opts.timestack.format_style) for (const gen of gens)gen.patch_formats(opts == null ? void 0 : opts.timestack.format_style);
    }
    init(options) {
    ...
    _dt_from_ts(ts) {
        return (0, _luxon.DateTime).fromMillis(ts, this._dt_opts);
    }
    _dt_from_object(obj) {
        return (0, _luxon.DateTime).fromObject(obj, this._dt_opts);
    }
    _dt_now() {
        return (0, _luxon.DateTime).local(this._dt_opts);
    }
    ...
    _choose_gen(range) {
        ...
        for (const gen of gens){
            ...
            if (max_density <= density_limit && max_nticks <= nticks_limit) candidates.push([
                gen,
                Math.abs(max_density - want_density)
            ]);
        }
...
// src/index.ts
(0, _chartJs.Chart).register(TimestackScale);

},{"chart.js":"ipU8D","luxon":"dpK6X","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dpK6X":[function(require,module,exports,__globalThis) {
'use strict';
